<?php
  ...
  $config_db["default"]["db"]   = "nusaaccounting_dev";
  $config_db["default"]["user"] = "root";
  $config_db["default"]["password"] = "wesolve2008";
  ...
  //
  // $config_defaulttheme = "elly_accounting";
  // $config_defaulttheme = "ellyBrownTop";
  $config_defaulttheme = "elly_nas";
  // $config_defaulttheme = "ellynextblue";
  $config_defaultthemecss = $config_defaulttheme . ".css";
  ...
  $config_authentication_cookie_expire = 30;
  ...
  $config_logo = "./images/nas-icon.png";
