...
<div id="box-menu"><span id="mainMenu"></span></div>

<div class="box">
    <!-- <div class="box-title">{atktext login_form}</div> -->
    <div class="box-content" style="padding:20px;">
        <div style="float:left;"><a href="index.php"><img src="{if empty($theme_logo)}{atkthemeimg logo.gif}{else}{$theme_logo}{/if}" alt="Logo" /></a></div>
        <fieldset id="elfield">
            <div id="conelfield">
                <legend>{$title}</legend>
